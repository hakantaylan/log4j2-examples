...
public class MDCApp2 {

    private static Logger logger;
    private final ExecutorService dbExecutor = new MDCAwareThreadPoolExecutor(5, namedThreadFactory("dbThread"));
    private final ExecutorService webExecutor = new MDCAwareThreadPoolExecutor(5, namedThreadFactory("webthread"));
    ...
    static {
        try {
            ...
            logger = LogManager.getLogger(MDCApp2.class);
        } catch (Exception ex) {
            // Handle here
            ex.printStackTrace();
        }
